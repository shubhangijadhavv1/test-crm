...
// 3) Late beyond grace
{
    const r = (0, engine_1.computeDay)({ clockIn: at('09:20'), clockOut: at('18:00'), ticks: [], breaks: [], policy: base });
...
{
    const r = (0, engine_1.computeDay)({ clockIn: at('11:30'), clockOut: at('18:00'), ticks: [], breaks: [], policy: { ...base, halfDayAfterMinutes: 120 } });
...
{
    const r = (0, engine_1.computeDay)({ clockIn: at('09:00'), clockOut: at('10:00'), ticks: idleTicks(15), breaks: [], policy: base });
...
{
    const p = (0, engine_1.policyFromBranch)({ shift: { startTime: '10:00', graceMinutes: 10 }, breaks: { lunchMinutes: 45, teaMinutes: 15, billingModel: 'A' }, monitoring: { halfDayAfterMinutes: 90 } });
